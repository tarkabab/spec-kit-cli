...
[![Release](https://github.com/tarkabab/spec-kit-cli/actions/workflows/release.yml/badge.svg)](https://github.com/tarkabab/spec-kit-cli/actions/workflows/release.yml)
...
```bash
uv tool install specify-cli --from git+https://github.com/tarkabab/spec-kit-cli.git
```
...
```bash
uvx --from git+https://github.com/tarkabab/spec-kit-cli.git specify init <PROJECT_NAME>
```
...
| `--ai`                 | Option   | AI assistant to use: `claude`, `gemini`, `copilot`, `cursor`, `qwen`, `opencode`, `codex`, `windsurf`, `kilocode`, `auggie`, `roo` or `cline` |
...
For support, please open a [GitHub issue](https://github.com/tarkabab/spec-kit-cli/issues/new). We welcome bug reports, feature requests, and questions about using Spec-Driven Development.
