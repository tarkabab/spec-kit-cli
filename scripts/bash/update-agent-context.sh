...
update_specific_agent() {
    ...
    case "$agent_type" in
        ...
        *)
            ...
            log_error "Expected: claude|gemini|copilot|cursor|qwen|opencode|codex|windsurf|kilocode|auggie|roo|cline"
            exit 1
            ;;
    esac
}
...
print_summary() {
    ...
    echo
    log_info "Usage: $0 [claude|gemini|copilot|cursor|qwen|opencode|codex|windsurf|kilocode|auggie|roo|cline]"
}
